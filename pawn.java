...
public class Pawn extends Piece{
	...
	public boolean isMoveLegal(int x, int y) {
		// TODO Auto-generated method stub
		if((isVerticalDoubleStepPossible(x,y)) && isInBounds(x,y) && (this.getHasMovedOnce()== false)) //A pawn can double-step if it has never moved
		{ 
			return true;
		}  
		...
		return false; 
		//A pawn can move diagonally too when killing another piece, but we will handle that in the board logic 
		//We will also set the HasMovedOnce to true in the board logic, since that handles the physical movements of the pieces
	}
